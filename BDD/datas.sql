...
-- dim. 08 avril 2018 10:11:12 CEST
...
START TRANSACTION;
USE `mydb`;
INSERT INTO `mydb`.`Games` (`name`, `infos`, `release`, `show`) VALUES ('Zelda', 'infos1', '2015-06-15', true);
INSERT INTO `mydb`.`Games` (`name`, `infos`, `release`, `show`) VALUES ('Mario', 'infos2', '2016-11-25', true);
INSERT INTO `mydb`.`Games` (`name`, `infos`, `release`, `show`) VALUES ('Sonic', 'infos3', '2017-03-29', true);
INSERT INTO `mydb`.`Games` (`name`, `infos`, `release`, `show`) VALUES ('Pokemon', 'infos4', '1996-09-15', true);
INSERT INTO `mydb`.`Games` (`name`, `infos`, `release`, `show`) VALUES ('Yu-Gi-Ho', 'infos5', '2005-05-15', true);
